...
Agora, faremos a análise de diagnóstico para verificar a adequação do modelo.
...
```{r}
residualPlot(modelp, pch = 16, type = "rstudent",
             main = "Resíduos studentizados x Valores ajustados")
```
